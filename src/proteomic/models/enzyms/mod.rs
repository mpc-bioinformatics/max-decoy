...
pub fn get<'t>(enzym_name: &str, database_connection: &'t postgres::Connection, max_number_of_missed_cleavages: i16, min_peptide_length: usize, max_peptide_length: usize) -> impl DigestEnzym<'t> {
